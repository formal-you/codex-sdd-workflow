...
- 日期：2026-04-18
- 审计人：Codex
- 目标版本或分支：当前工作区快照（本仓库未检测到 Git 分支元信息）
...
3. **补充了实操指南**：新增了“核心命令速查”与“关键文件用法速查表”，填补了使用者“装完后不知道怎么用”的空白阶段，并增加了首次装配与已有旧版项目的逻辑区分。
4. **规范了专业术语**：将生硬的机器翻译感词汇（如“下一步纪律”）更迭为更具温度且符合工程直觉的词汇（如“下一步指引”、“执行规范”），同时保证 41 个 unittest 依然稳定匹配覆盖。
